...
/*
	private void createMainGui(String string) {
		// TODO Auto-generated method stub

		frame1 = new JFrame (string + " This is the Main GUI");
		frame1.setMinimumSize(new Dimension(640,480));

		JLabel testLabel = new JLabel("This is the Main GUI");
		JLabel testLabel1 = new JLabel(string);
		JLabel testLabel2 = new JLabel("Size of Grid: ");
		JLabel testLabel11 = new JLabel("Your First Score: ");
		JLabel testLabel12 = new JLabel("Your Second Score: ");
		JLabel testLabel13 = new JLabel("Your Third Score: ");
		JLabel testLabel21;
		...
		//frame1.add(testLabel);
		//frame1.add(testLabel1);
		frame1.add(testLabel11);
		frame1.add(myFirst);
		frame1.add(testLabel12);
		frame1.add(mySecond);
		frame1.add(testLabel13);
		frame1.add(myThird);
		frame1.add(testLabel21);
		frame1.add(oppFirst);
		frame1.add(testLabel22);
		frame1.add(oppSecond);
		frame1.add(testLabel23);
		frame1.add(oppThird);
